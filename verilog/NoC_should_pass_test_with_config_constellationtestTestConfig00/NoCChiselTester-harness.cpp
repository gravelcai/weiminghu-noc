...
#define TOP_CLASS VNoCChiselTester
...
#endif
#if VM_COVERAGE
  VerilatedCov::write("/home/gravel/repos/weiminghu-noc/test_run_dir/NoC_should_pass_test_with_config_constellationtestTestConfig00/coverage.dat");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = "/home/gravel/repos/weiminghu-noc/test_run_dir/NoC_should_pass_test_with_config_constellationtestTestConfig00/NoCChiselTester.";

...
#ifndef VERILATED_VNOCCHISELTESTER_INPUTUNIT_H_
#define VERILATED_VNOCCHISELTESTER_INPUTUNIT_H_  // guard
...
class VNoCChiselTester_InputUnit final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    VNoCChiselTester_InputUnit(VNoCChiselTester__Syms* symsp, const char* name);
    ~VNoCChiselTester_InputUnit();
    VL_UNCOPYABLE(VNoCChiselTester_InputUnit);

...
VL_ATTR_COLD void VNoCChiselTester_InputUnit_2___ctor_var_reset(VNoCChiselTester_InputUnit_2* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VNoCChiselTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+                VNoCChiselTester_InputUnit_2___ctor_var_reset\n"); );
    // Body
...
VL_ATTR_COLD void VNoCChiselTester_InputUnit_2___configure_coverage(VNoCChiselTester_InputUnit_2* vlSelf, bool first) {
    if (false && vlSelf) {}  // Prevent unused
    VNoCChiselTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+                VNoCChiselTester_InputUnit_2___configure_coverage\n"); );
    // Body

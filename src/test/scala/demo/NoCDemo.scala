...
class NoCDemo(implicit p: Parameters) extends LazyModule with HasNoCParams {
  val allChannelParams = nocParams.channelParams
  val allIngressParams = nocParams.ingressParams
  val allEgressParams = nocParams.egressParams
  val allRouterParams = nocParams.routerParams
  ...
  class Impl extends LazyModuleImp(this) {
    ...
    ElaborationArtefacts.add(prepend("nocdemo.graphml"), graphML)
    ...
    ElaborationArtefacts.add(prepend("nocdemo.adjlist"), adjList)
    ...
    val xys = routers.map(r => {
      ...
      val plotter = nocParams.userParams.topology.plotter
    ...
    ElaborationArtefacts.add(prepend("nocdemo.xy"), xys)
    ...
    ElaborationArtefacts.add(prepend("nocdemo.edgeprops"), edgeProps)
